...
const translations = {
  en: {
    ...
    aiToolsLive: "Partner link live",
    aiToolsCandidate: "Partner candidate",
    aiToolsSoon: "Link coming soon",
    aiToolsPendingCta: "Partner link soon",
    aiToolsRoadmap: "We only activate a partner button after BlankDigi has an approved referral link. More video and voice tools will be added to this stack.",
    synthesiaDescription: "AI avatar video production for explainers, training, sales, and business content.",
    synthesiaCap1: "AI Avatars",
    synthesiaCap2: "Business Video",
    synthesiaCap3: "Multilingual",
    veedDescription: "Browser-based AI video creation, editing, subtitles, and fast social-video production.",
    veedCap1: "AI Video",
    veedCap2: "Editing",
    veedCap3: "Captions",
    pictoryDescription: "Turn scripts and long-form content into branded videos and reusable short-form assets.",
    pictoryCap1: "Script → Video",
    pictoryCap2: "Repurposing",
    pictoryCap3: "Short Clips",
    invideoDescription: "Prompt-driven video generation for ads, social posts, explainers, and rapid creative testing.",
    invideoCap1: "Prompt → Video",
    invideoCap2: "AI Ads",
    invideoCap3: "Social Content",
    opusDescription: "Repurpose long videos into vertical clips designed for Shorts, Reels, and TikTok.",
    opusCap1: "Long → Short",
    opusCap2: "Auto Reframe",
    opusCap3: "Social Clips",
    filterAll: "🌐 All",
  ...
  fr: {
    ...
    aiToolsLive: "Lien partenaire actif",
    aiToolsCandidate: "Partenaire potentiel",
    aiToolsSoon: "Lien bientôt disponible",
    aiToolsPendingCta: "Lien partenaire bientôt",
    aiToolsRoadmap: "Nous activons un bouton partenaire uniquement lorsque BlankDigi dispose d'un lien de parrainage approuvé. D'autres outils vidéo et voix seront ajoutés à cette stack.",
    synthesiaDescription: "Production vidéo avec avatars IA pour l'explication, la formation, la vente et le contenu professionnel.",
    synthesiaCap1: "Avatars IA",
    synthesiaCap2: "Vidéo Business",
    synthesiaCap3: "Multilingue",
    veedDescription: "Création et montage vidéo IA dans le navigateur, sous-titres et production rapide pour les réseaux sociaux.",
    veedCap1: "Vidéo IA",
    veedCap2: "Montage",
    veedCap3: "Sous-titres",
    pictoryDescription: "Transformez scripts et contenus longs en vidéos de marque et en assets courts réutilisables.",
    pictoryCap1: "Script → Vidéo",
    pictoryCap2: "Repurposing",
    pictoryCap3: "Clips Courts",
    invideoDescription: "Génération vidéo par prompt pour publicités, contenus sociaux, vidéos explicatives et tests créatifs rapides.",
    invideoCap1: "Prompt → Vidéo",
    invideoCap2: "Publicités IA",
    invideoCap3: "Contenu Social",
    opusDescription: "Transformez les vidéos longues en clips verticaux pour Shorts, Reels et TikTok.",
    opusCap1: "Long → Court",
    opusCap2: "Recadrage Auto",
    opusCap3: "Clips Sociaux",
    filterAll: "🌐 Tous",
